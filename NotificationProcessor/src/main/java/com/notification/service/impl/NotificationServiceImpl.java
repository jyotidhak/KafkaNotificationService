...
public class NotificationServiceImpl implements NotificationService {
	...
	private static final String EMAIL_TOPIC = "email.notification";

	private static final String SMS_TOPIC = "sms.notification";

	private static final String DQ_TOPIC = "dq.notification";
	...
	public void processNotification(String payload) {
		...
		//payloadJsonObject = redisService.evaluateAndUpdatePayload("account", payloadJsonObject);
